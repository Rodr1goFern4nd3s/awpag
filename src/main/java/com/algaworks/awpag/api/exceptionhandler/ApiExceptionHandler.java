...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    /*
    Esta classe será responsável por capturar excessões de toda a aplicação(ExceptionHandler global) de forma que nós não precisaremos
    criar capturas de exceções em cada controlador
     */
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        problemDetail.setType(URI.create("https://algaworks.com/erros/campos-inválidos"));
